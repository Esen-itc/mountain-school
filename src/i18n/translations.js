...
export const translations = {
  ru: {
    ...
    prizes: {
      ...
      stats: '3 призовых места · $5 000 призовой фонд · Все участники получают сертификат',
      list: [
        {
          title: 'Гран-при',
          amount: '$2 500',
          description:
            'Денежный приз + публикация проекта в архитектурных изданиях + приглашение на церемонию в Бишкеке.',
        },
        {
          title: 'Второе место',
          amount: '$1 500',
          description:
            'Денежный приз + именной сертификат победителя + публикация проекта на сайте конкурса.',
        },
        {
          title: 'Третье место',
          amount: '$1 000',
          description:
            'Денежный приз + именной сертификат + включение в итоговый каталог конкурса.',
        },
      ],
      bonus: {
        title: 'Все участники получают',
        items: [
          'Именной сертификат участника международного конкурса',
          'Доступ к закрытой базе материалов о месте проектирования',
          'Возможность попасть в итоговый каталог лучших работ',
        ],
      },
    },
    timeline: {

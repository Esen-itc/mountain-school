...
export const translations = {
  ru: {
    ...
    about: {
      ...
      lead: 'Спроектируйте начальную школу для горного села в Кыргызстане — место, где дети учатся, а село живёт.',
      body: 'Конкурс открыт для студентов и молодых архитекторов из стран СНГ. Мы ищем идеи, которые соединяют локальную традицию, современную архитектуру и реальную пользу для общины. Лучшие работы будут представлены международному жюри и опубликованы в архитектурных медиа.',
      items: {
        context: {
          title: 'Контекст',
          text: 'Школа в горном селе на высоте 2 100 м. Сложный рельеф, климат и сейсмика — настоящий вызов архитектору.',
        },
        education: {
          title: 'Образование',
          text: 'Здание для 30–50 учеников 1–4 классов. Светлые классы, библиотека, мастерские и пространства для игр.',
        },
        social: {
          title: 'Социальная роль',
          text: 'После уроков школа становится центром села: лекции, события, встречи общины.',
        },
        jury: {
          title: 'Международное жюри',
          text: 'Архитекторы из Чикаго, преподаватели университетов и партнёры — оценят каждый проект.',
        },
      },
    },
    brief: {
    ...
    prizes: {
      ...
      subtitle:
        'Победители получают денежный приз. Все участники — сертификат участника международного архитектурного конкурса.',
      fundLabel: 'Общий призовой фонд',
      fundAmount: '$5 000',
      fundNote: 'Распределяется между тремя призовыми местами и поощрениями жюри.',
      list: [
        {
          title: 'Гран-при',
          amount: '$2 500',
    ...
    timeline: {
      ...
      subtitle:
        'Конкурс рассчитан на четыре месяца — этого достаточно, чтобы изучить контекст, развить концепцию и оформить полноценную подачу.',
      list: [
        {
          period: '01 — 15 мая 2026',
          title: 'Открытие приёма заявок',
          text: 'Регистрация участников, рассылка технического задания и материалов о селе.',
        },
        {
          period: '15 мая — 30 июня',
          title: 'Разработка концепции',
          text: 'Аналитика контекста, генерация идей, консультации с менторами и координаторами.',
        },
        {
          period: '01 — 31 июля',
          title: 'Финальная подача',
          text: 'Сдача итоговых планшетов, описаний и визуализаций согласно требованиям.',
        },
        {
          period: '01 — 20 августа',
          title: 'Работа жюри',
          text: 'Международное жюри оценивает работы по утверждённым критериям и формирует шорт-лист.',
        },
        {
          period: '05 сентября',
          title: 'Объявление победителей',
          text: 'Онлайн-церемония, публикация результатов и приглашение финалистов в Бишкек.',
        },
      ],
    },
    criteria: {
      ...
      subtitle:
        'Пять равных критериев — от концепции до устойчивости. Каждый одинаково важен для итоговой оценки.',
      list: [
        { score: '20', title: 'Концепция' },
        { score: '20', title: 'Функция' },
        { score: '20', title: 'Ландшафт' },
        { score: '20', title: 'Подача' },
        { score: '20', title: 'Устойчивость' },
      ],
      caption: 'Каждый критерий — 20 баллов. Максимум — 100.',
    },
    jury: {
      eyebrow: 'Жюри',
      title: 'Кто <em>оценит</em> ваши идеи.',
      subtitle:
        'Архитекторы и преподаватели, которые внимательно прочитают каждую подачу и выберут лучшие работы.',
      list: [
        {
          photo: '',
          role: 'Организатор • Жюри',
          name: 'Анна Каримова',
          meta: 'Архитектор-партнёр, Studio Karimova',
        ...
        },
        {
          ...
          role: 'Жюри',
          name: 'Дэвид Маршалл',
          meta: 'Старший архитектор, Skyline Architects',
          city: 'Чикаго, США',
        },
        {
          photo: '',
          role: 'Жюри',
          name: 'Тимур Алиев',
          meta: 'Доцент кафедры архитектуры, КГУСТА',
          city: 'Бишкек, Кыргызстан',
        },
      ],
    },
    format: {
      ...
      subtitle:
        'Конкурс открыт для индивидуального участия и команд до трёх человек. Выбирайте формат, в котором вы сильнее всего.',
      items: {
        solo: {
          label: 'Индивидуально',
          title: 'Один автор',
          text: 'Полная авторская свобода. Подойдёт студентам, готовым взять ответственность и развивать собственный почерк.',
          bullets: [
            'Один автор',
            'Один сертификат',
            'Возможна научная консультация ментора',
          ],
        },
        team: {
          label: 'Команда',
          title: '2 — 3 участника',
          text: 'Работа в команде до трёх человек. Подходит для междисциплинарных проектов: архитектор + инженер + дизайнер.',
          bullets: [
            'От 2 до 3 авторов',
            'Сертификаты для всех',
            'Один контактный лидер команды',
          ],
        },
      },
    },
    faq: {
      ...
      subtitle:
        'Коротко о главном. Если не нашли ответ — напишите нам, и мы поможем.',
      list: [
        {
    ...
    register: {
      ...
      subtitle:
        'Заполните форму, и сайт подготовит письмо с вашей заявкой в почтовой программе.',
      note: 'Проверьте подготовленное письмо и нажмите «Отправить» в почтовом клиенте.',
